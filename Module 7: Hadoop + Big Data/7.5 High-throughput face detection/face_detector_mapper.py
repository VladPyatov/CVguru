...
sys.path.insert(0, "project.zip")
from project.hadoop.mapper import Mapper
from project.face_detection import FaceDetector
...
def job():
    ...
    for line in Mapper.parse_input(sys.stdin):
        ...
        imageID, path, image = Mapper.handle_input(line)

        # detect the raw faces in the image and initialize the list of faces we'll be using
