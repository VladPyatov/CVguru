...
def describe(image):
    ...
    # return a concatenated feature vector of color statistics and Haralick texture features
...
for imagePath in imagePaths:
    ...
    # extract features from the image, update the list of labels and features
    data.append(describe(image))
    labels.append(label)
...
for i in np.random.randint(0, len(imagePaths), size=(10,)):
