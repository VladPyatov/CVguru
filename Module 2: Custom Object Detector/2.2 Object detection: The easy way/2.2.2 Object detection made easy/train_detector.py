...
ap.add_argument("-c", "--class", required=True, help="Path to the images")
ap.add_argument("-a", "--annotations", required=True, help="Path to the annotations")
...
for imagePath in paths.list_images(args["class"]):
    ...
    p = f"{args['annotations']}/annotation_{imageID}"
