...
class Searcher:
    ...
    def search(self, queryHist, numResults=10, maxCandidates=200):
        ...
        for candidate, hist in zip(candidateIdxs, hists):
            ...
            # compute the distance between the histograms and update the results dictionary
    ...
    def buildCandidates(self, hist, maxCandidates):
        ...
        # loop over the pipeline results, extract the image index, and update the candidates list
