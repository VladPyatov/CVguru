...
class FeatureIndexer(BaseIndexer):
    def __init__(self, dbPath, estNumImages=500, maxBufferSize=50000, dbResizeFactor=2, verbose=True):
        ...
        super(FeatureIndexer, self).__init__(dbPath=dbPath, estNumImages=estNumImages, maxBufferSize=maxBufferSize,
        ...
        # initialize the image ID's buffer, index buffer, and the keypoints + features buffer
        self.imageIDBuffer = []
        self.indexBuffer = []
    ...
    def add(self, imageID, kps, features):
        # compute the starting and ending index for the feature lookup
    ...
    def finish(self):
        ...
        # write any un-empty buffers to file
